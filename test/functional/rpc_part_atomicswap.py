...
def createRefundTxCT(node, rawtx, output_amounts, script, lockTime, privKeySign, pubKeySign, addrRefundTo):
    ...
    ro = node.createrawfalcontransaction(inputs, outputs, lockTime)
    rawtxrefund = ro['hex']
...
def createClaimTxCT(node, rawtx, output_amounts, script, secret, privKeySign, pubKeySign, addrClaimTo):
    ...
    ro = node.createrawfalcontransaction(inputs, outputs)
    rawtxClaim = ro['hex']
...
class AtomicSwapTest(ParticlTestFramework):
    ...
    def test_cttx(self):
        ...
        ro = nodes[0].createrawfalcontransaction([], outputs)
        ...
        ro = nodes[1].createrawfalcontransaction([], outputs)
    ...
    def test_deterministicrangeproof(self):
        ...
        txA = nodes[1].createrawfalcontransaction([], outputs)
        txB = nodes[0].createrawfalcontransaction([], outputs)
