...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "burn", 0, "amount" },
    { "sendfalcontoblind", 1, "amount" },
    { "sendfalcontoblind", 4, "subtractfeefromamount" },
    { "sendfalcontoanon", 1, "amount" },
    { "sendfalcontoanon", 4, "subtractfeefromamount" },

    { "sendblindtofalcon", 1, "amount" },
    { "sendblindtofalcon", 4, "subtractfeefromamount" },
    ...
    { "sendanontofalcon", 1, "amount" },
    { "sendanontofalcon", 4, "subtractfeefromamount" },
    { "sendanontofalcon", 6, "ringsize" },
    { "sendanontofalcon", 7, "inputs_per_sig" },
    ...
    { "createrawfalcontransaction", 0, "inputs" },
    { "createrawfalcontransaction", 1, "outputs" },
    { "createrawfalcontransaction", 2, "locktime" },
    { "createrawfalcontransaction", 3, "replaceable" },
